...
#define STM32_FLASH_FIAG 0x0800FC00	//STM32 存储地址
#define STM32_FLASH_ADMINPASS 0x0800FC02	//STM32 存储地址
#define STM32_FLASH_FINGERCNT 0x0800FC04	//STM32 存储地址
#define STM32_FLASH_FACECNT  0x0800FC06	//STM32 存储地址
